...
- Wallets: injected EVM and Solana wallet connect buttons for operator identity checks. WalletConnect/Reown-grade admin signing remains a production hardening step.
